...
The xclbin is registered as the `saxpy_xclbin` target only when `ACCEL_PLATFORM_KIND=alveo_u250`; other kernel presets can still configure without this U250-specific link file.
