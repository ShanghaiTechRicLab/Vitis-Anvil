...
5. [构建系统模型](build_system.md) — stage-specific action graph、stamp、depfile、action key 和运行输出布局。
6. [加速卡流程](accelerator_flow.md) — U250/U50/U55C/U200/U280/VCK5000 这类 PCIe 加速卡的流程。
7. [Embedded 流程](embedded_flow.md) — ZCU102/ZCU104/ZCU106/KV260 这类板卡的流程。
8. [部署指南](deploy.md) — 文件如何放到真实板卡/加速卡上运行，出错怎么查。
9. [自定义指南](customization.md) — 添加自己的 kernel、host app、数据集、板卡和报告。
